      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div className="space-y-12">
          <div className="space-y-4">
            <h3 className="text-gold-accent font-montserrat uppercase tracking-[0.5em] text-xs font-bold">Contacto</h3>
        ...
        {/* Right Side: Simple Form - Light Mode */}
        <motion.div 
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <div className="space-y-2">
                <label className="text-charcoal/40 text-[9px] uppercase tracking-widest font-bold">Nome</label>
                <input 
                  type="text" 
                  value={formData.nome}
             ...
             <div className="space-y-2">
                <label className="text-charcoal/40 text-[9px] uppercase tracking-widest font-bold">Empresa</label>
                <input 
                  type="text" 
          ...
          <div className="space-y-2">
             <label className="text-charcoal/40 text-[9px] uppercase tracking-widest font-bold">Sua Visão</label>
             <textarea 
               rows="4" 
               value={formData.visao}
               onChange={(e) => setFormData({...formData, visao: e.target.value})}
               className="w-full bg-transparent border-b border-black/10 py-2 text-deep-grey focus:border-gold-accent outline-none transition-colors custom-scrollbar" 
